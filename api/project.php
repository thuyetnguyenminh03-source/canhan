...
$stmt = $pdo->prepare('SELECT id, title_vi, title_en, slug, description_vi, description_en, summary_vi, summary_en,
...
$mediaStmt = $pdo->prepare('SELECT section,url,title FROM project_media WHERE project_id=? ORDER BY section,id');
...
$testimonials = $pdo->prepare('SELECT content_vi as quote_vi, content_en as quote_en, author_name as author, author_title as role_title FROM testimonials WHERE project_id=? ORDER BY id');
